...
if __name__ == '__main__':
    ...
    counter_test_positivi += tester_fun(Ex1, ['giraffa giraffo'],6)
    counter_test_positivi += tester_fun(Ex1, ['pegnorto'],7)
    counter_test_positivi += tester_fun(Ex1, ['spola '],6)
    counter_test_positivi += tester_fun(Ex1, ['passaggio obbligato'],7)
    counter_test_positivi += tester_fun(Ex1, ['proviamole tutte'],10)
